          ...
          <div className="space-y-4 py-4">
            ...
            <div>
              ...
              <div className="flex justify-between text-xs text-muted-foreground mt-1">
                <span>Full debt: ${totalDebt.toFixed(2)}</span>
                <span>Balance: {(balances?.usdc || 0).toFixed(2)} USDC</span>
              </div>
            </div>
            <Button
              className="w-full"
            ...
            <div>
              ...
              <div className="flex gap-2">
                ...
                <Button
                  ...
                  size="sm"
                  onClick={() =>
                    setAddCollateralAmount((balances?.xlm || 0).toFixed(2))
                  }
                >
                  Max
                </Button>
              ...
              <p className="text-xs text-muted-foreground mt-1">
                Available:{" "}
                {(balances?.xlm || 0).toLocaleString(undefined, {
        ...
        <DialogContent className="max-w-md">
          ...
          <div className="space-y-4 py-4">
            ...
            <div>
              ...
              />
              <p className="text-xs text-muted-foreground mt-1">
                Max withdrawable without affecting health
              </p>
            </div>
            <Button
              className="w-full"
